[![Build Status](https://travis-ci.org/devecho/sync-echo-build.png?branch=master)](https://travis-ci.org/devecho/sync-echo-build)
...
Commercial use is prohibited. Derivate Work is prohibited. And so on...
